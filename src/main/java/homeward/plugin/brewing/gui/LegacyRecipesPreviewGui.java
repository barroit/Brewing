...
public class LegacyRecipesPreviewGui {
    ...
    private LegacyRecipesPreviewGui(int rows, int pageSize) {
        this.recipesLevelMap = Container.RECIPE_TIER;
    ...
    public static LegacyRecipesPreviewGui getInstance(int rows, int pageSize) {
        if (null == instance) {
            synchronized (LegacyRecipesPreviewGui.class) {
                if (null == instance) {
                    instance = new LegacyRecipesPreviewGui(rows, pageSize);
                }
            }
        }
        return instance;
